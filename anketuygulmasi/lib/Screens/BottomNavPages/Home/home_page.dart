                                        ...
                                        builder: (context, vote, child) {
                                          ...
                                          return GestureDetector(
                                            onTap: (){
                                              ...
                                              if(voters.isEmpty){
                                                log("No vote");
                                                vote.votePoll(pollId: data.id, pollData: data, previousTotalVotes: poll["total_votes"], selectedOptions: dataOption["answer"]);
                                              }else {
                                                final isExists =
                                                voters.firstWhere(
                                                        (element) =>
                                              ...
                                              /*else{
                                                for(var i in voters){
                                                  if(i["uid"]==user!.uid){
                                                    error(context, message: "You already voted");
                                                    return;
                                                  }
                                                  if(i["uid"]!=user!.uid){
                                                    vote.votePoll(
