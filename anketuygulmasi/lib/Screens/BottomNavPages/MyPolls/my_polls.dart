...
import 'package:anketuygulmasi/Screens/BottomNavPages/MyPolls/add_new_polls.dart';
                ...
                slivers: [
                  SliverToBoxAdapter(
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...List.generate(polls.usersPollsList.length, (index) {
                            final data=polls.usersPollsList[index];
                                  ...
                                  ListTile(
                                    ...
                                    trailing: Consumer<DbProvider>(
                                      builder: (context, delete, child) {
                                        ...
                                        return IconButton(
                                          onPressed: delete.deleteStatus==true ? null
                                            :()
                                          {
