import 'package:anketuygulmasi/Providers/db_provider.dart';
...
class _AddPollPageState extends State<AddPollPage> {
              ...
              child: Form(
                ...
                child: Column(
                  children: [
                    ...
                    formWidgets(question, label: "Question"),
                    formWidgets(option1, label: "Option 1"),
                    formWidgets(option2, label: "Option 2"),
                    formWidgets(duration, label: "Duration", onTap: () {
                      showDatePicker(
                              context: context,
                    ...
                    Consumer<DbProvider>(builder: (context, db, child) {
                      ...
                      return GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Text(
                              db.status == true ? "Please wait" : "Post Poll"),
                        ),
                      );
                    }),
                  ],
  ...
  Widget formWidgets(TextEditingController controller,
